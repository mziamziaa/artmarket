...
import { ShoppingCartIcon, PlusIcon, PlusCircleIcon } from "@heroicons/react/outline";
    ...
    <Link href={`/products/${product._id}`}>
      <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden cursor-pointer hover:shadow-2xl transition">
        <div className="flex items-end justify-end h-56 w-full bg-cover relative">
          ...
          />
          <button className="absolute z-10 p-2 rounded-full bg-gray-600 text-white mx-5 -mb-4 hover:bg-gray-500 focus:outline-none focus:bg-gray-500">
